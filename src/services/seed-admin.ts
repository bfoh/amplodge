 ...
 * 
 * In production, admin accounts must be created manually through the Blink dashboard
 */
export async function seedAdminAccount() {
  ...
  if (import.meta.env.PROD) {
    ...
    console.log('⚠️ Admin accounts must be created manually through Blink dashboard')
    return { success: true, alreadyExists: true, skipped: true }
  }

  try {
    const adminEmail = 'admin@amplodge.com'
    const adminPassword = 'AdminAMP2025!'
